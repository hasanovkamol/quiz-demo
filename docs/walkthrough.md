...
17. **Telegram Bot Security, Admin Restrictions & Performance Optimizations**: [`TelegramInitDataValidator.cs`](file:///home/user02/Projects/AI%20Projects/Qiuz/backend/Infrastructure/Telegram/TelegramInitDataValidator.cs), [`TelegramEndpoints.cs`](file:///home/user02/Projects/AI%20Projects/Qiuz/backend/Endpoints/TelegramEndpoints.cs) va [`TelegramBotService.cs`](file:///home/user02/Projects/AI%20Projects/Qiuz/backend/Infrastructure/Telegram/TelegramBotService.cs) — Telegram Mini App HMAC SHA256 initData auth, non-blocking webhook task execution, `/leaderboard` (va `showleaderboard` callback) faqat `Admin` rolidagi foydalanuvchilar (`HasanovKamol`) uchun ruxsat etilgan.
